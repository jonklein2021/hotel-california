...
DECLARE
    founded TIMESTAMP := TO_TIMESTAMP('12-08-1976 16:00', 'MM-DD-YYYY HH24:MI');
    res_id_i VARCHAR(5);
    in_time_i TIMESTAMP;
...
BEGIN
    ...
    -- add a couple more recent records
    FOR i in 81..85
    LOOP
        usd_total := 0;
        points_total := 0;
        ...
        rand := round(DBMS_RANDOM.VALUE(0, 4));
        in_time_i := (founded - 2 + rand);
